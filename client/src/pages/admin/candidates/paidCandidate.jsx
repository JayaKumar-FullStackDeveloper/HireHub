            ...
            <tbody>
              {paidOnly.map((user, index) => (
                ...
                >
                  ...
                  <td className="py-2 px-3 border whitespace-nowrap text-base font-normal">{user.paymentStatus}</td>
                  <td className="py-2 px-3 border whitespace-nowrap text-base text-green-600 font-medium "><span className='bg-green-50 py-1 px-4 rounded-md '>{user.paymentStatus}</span></td>
