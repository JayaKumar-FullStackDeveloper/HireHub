...
const JobAppllication = ({ isCollapsed }) => {
  ...
  useEffect(() => {
    const fetchjobs = async () => {
      try {
        const response = await axios.get('http://localhost:4000/api/jobs/getall');
  ...
  return (
    <div className={`mx-auto ${isCollapsed ? 'max-w-7xl' : 'max-w-6xl'}`}>
      <div className='w-full justify-between flex mb-2'>
        <h1 className="text-2xl font-bold text-left">Job Application</h1>
      </div>
          ...
          <table className="w-full bg-white border-collapse border-0">
            <thead className="bg-gray-200 sticky -top-0 w-full">
              <tr className='w-full'>
                ...
                <th className="py-2 px-4 border whitespace-nowrap">Job Title</th>
                <th className="py-2 px-4 border whitespace-nowrap">Graduation Year </th>
              ...
              jobs.map((data, index) => (
                ...
                >
                  ...
                  <td className="py-2 px-3 border-y whitespace-nowrap text-base font-normal overflow-hidden text-ellipsis">{data.lastName}</td>
                    ...
                    <td className="py-2 px-3 border-y whitespace-nowrap text-base font-normal overflow-hidden text-ellipsis">{data.jobTitle}</td>
                        ...
                        <td className="py-2 px-3 border-y whitespace-nowrap text-base font-normal">{data.passedOut}</td>
...
export default JobAppllication;
