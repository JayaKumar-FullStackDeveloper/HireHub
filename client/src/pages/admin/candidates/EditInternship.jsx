...
const EditInternship = ({
    ...
    const validateForm = () => {
        const emailValid = validateEmail(selectedInternship.email);
        const numberValid = validateNumber(selectedInternship.contactNumber);
    ...
    const handleSubmit = async (e) => {
        ...
        Object.entries(selectedInternship).forEach(([key, value]) =>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id="firstName"
                                name="firstName"
                                value={selectedInternship.firstName}
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id="lastName"
                                name="lastName"
                                value={selectedInternship.lastName}
                                onChange={handleInputChange}
                                required
                                className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm p-2"
                            />
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id="email"
                                name="email"
                                value={selectedInternship.email}
                                onChange={handleInputChange}
                                onBlur={handleBlur}
                                required
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id="contactNumber"
                                name="contactNumber"
                                value={selectedInternship.contactNumber}
                                onChange={handleInputChange}
                                onBlur={handleBlur}
                                required
                                maxLength={10}
